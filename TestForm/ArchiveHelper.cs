...
namespace TestForm
{
    public static class ArchiveHelper
    {
        ...
        [DllImport("7zip.dll")]
        public static extern int OpenArchive(ref tOpenArchiveData archiveData);
        /// <summary>
        ...
        [DllImport("7zip.dll")]
        public static extern int ReadHeader(int handle, ref tHeaderData headerData);
        /// <summary>
        ...
        [DllImport("7zip.dll")]
        public static extern void SetChangeVolProc(int handle, tChangeVolProc changeVolProc);
        /// <summary>
        ...
        [DllImport("7zip.dll")]
        public static extern void SetProcessDataProc(int handle, tProcessDataProc processDataProc);
        ...
        [DllImport("7zip.dll")]
        public static extern void PackSetDefaultParams(ref PackDefaultParamStruct dps);
        /// <summary>
        ...
        [DllImport("7zip.dll")]
        public static extern void PkSetCryptCallback(tPkCryptProc pPkCryptProc, int cryptoNr, int flags);
    }
    ...
    public delegate int tChangeVolProc(ref char arcName, int mode);
    public delegate int tProcessDataProc(ref char fileName, int size);
    public delegate int tPkCryptProc(int cryptoNr, int mode, ref char archiveName, ref char password, int maxlen);
