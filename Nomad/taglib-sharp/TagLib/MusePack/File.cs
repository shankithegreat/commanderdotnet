namespace TagLib.MusePack
{
    ...
    [SupportedMimeType("taglib/mpc", "mpc"), SupportedMimeType("taglib/mp+", "mp+"), SupportedMimeType("taglib/mpp", "mpp"), SupportedMimeType("audio/x-musepack")]
    public class File : TagLib.NonContainer.File
    {
        ...
        protected override void ReadStart(long start, ReadStyle propertiesStyle)
        {
            ...
            {
                base.Seek(start);
                this.header_block = base.ReadBlock(0x38);
            }
        }
    }
}
