namespace TagLib.Ape
{
    ...
    [SupportedMimeType("taglib/ape", "ape"), SupportedMimeType("audio/x-ape"), SupportedMimeType("audio/ape"), SupportedMimeType("application/x-ape")]
    public class File : TagLib.NonContainer.File
    {
        ...
        protected override void ReadStart(long start, ReadStyle propertiesStyle)
        {
            ...
            {
                base.Seek(start);
                this.header_block = base.ReadBlock(0x4c);
            }
        }
    }
}
