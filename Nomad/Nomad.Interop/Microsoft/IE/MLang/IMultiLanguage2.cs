namespace Microsoft.IE.MLang
{
    ...
    [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("DCCFC164-2B38-11D2-B7EC-00C04F8F5D9A")]
    public interface IMultiLanguage2
    {
        ...
        [PreserveSig]
        int DetectInputCodepage(MLDETECTCP flags, uint dwPrefWinCodePage, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=3)] byte[] pSrcStr, ref int pcSrcSize, [In, Out, MarshalAs(UnmanagedType.LPArray)] DetectEncodingInfo[] lpEncoding, ref int pnScores);
